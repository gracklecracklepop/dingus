    ...
    protected void paintComponent(Graphics g) {
        ...
        if (currentImage != null) {
            if (isDragging) {
                ...
                g2.drawImage(dragImage, 0, +100, BedDialog.imgW - 75, getHeight() -100, this);
            } else {
