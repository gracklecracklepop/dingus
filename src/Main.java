    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(() -> {
            ...
            hiddenOwner.setIconImages(List.of(
                    ...
                    icon.getScaledInstance(32,  32,  4),
                    icon.getScaledInstance(64,  64,  4),
            ...
            dialog.setSize(360, 290);
            dialog.setAlwaysOnTop(true);
            dialog.setResizable(false);

            Rectangle usable = Theme.getUsableScreen();
            dialog.setLocation(usable.x + usable.width - 360 - 40, usable.y + usable.height - 290);
